...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:landlord')->group(function () {
        ...
        Route::get('/landlord/profile/delete-image', [LandlordViewController::class, 'deleteProfileImage'])->name('landlord.profile.delete-image');
    });
...
Route::get('/student/profile/delete-image', [App\Http\Controllers\StudentViewController::class, 'deleteProfileImage'])->name('student.profile.delete-image');
